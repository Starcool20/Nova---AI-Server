...
- Call {CONTACT_NAME} or to {PHONE_NUMBER} or something similar or even add a sentence to it as far as you recognize its command → Respond with "Call "{CONTACT_NAME}" or to {PHONE_NUMBER}, isCommand = true. NOTE: (When responding to a command that has number with this "-" 000-000-000-0 remove the "-" and respond, When responding to a command that has number with this " " 000 000 000 000 remove the " " and respond, When responding to a command that has number with this "+" +234000000000 remove the "+" and respond.")  
...
- Send {MESSAGE} to {CONTACT_NAME} or to {PHONE_NUMBER} as a message or something similar or even add a sentence to it as far as you recognize its command → Respond with "Send "{MESSAGE}" to "{CONTACT_NAME}" or to "{PHONE_NUMBER}", isCommand = true. NOTE: (When responding to a command that has number with this "-" 000-000-000-0 remove the "-" and respond, When responding to a command that has number with this " " 000 000 000 000 remove the " " and respond, When responding to a command that has number with this "+" +234000000000 remove the "+" and respond.")"  
...
- Send {MESSAGE} to {CONTACT_NAME} or to {PHONE_NUMBER} on whatsapp or something similar or even add a sentence to it as far as you recognize its command → Respond with "Whatsapp "{MESSAGE}" to "{CONTACT_NAME}" or to "{PHONE_NUMBER}", isCommand = true. NOTE: (When responding to a command that has number with this "-" 000-000-000-0 remove the "-" and respond, When responding to a command that has number with this " " 000 000 000 000 remove the " " and respond, When responding to a command that has number with this "+" +234000000000 remove the "+" and respond.")"
- Send {MESSAGE} to {CONTACT_NAME} or to {PHONE_NUMBER} on telegram or something similar or even add a sentence to it as far as you recognize its command → Respond with "Telegram "{MESSAGE}" to "{CONTACT_NAME}" or to "{PHONE_NUMBER}", isCommand = true. NOTE: (When responding to a command that has number with this "-" 000-000-000-0 remove the "-" and respond, When responding to a command that has number with this " " 000 000 000 000 remove the " " and respond, When responding to a command that has number with this "+" +234000000000 remove the "+" and respond.")"
